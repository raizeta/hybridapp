...
.controller('LoginCtrl', function($scope, $state, $ionicPopup, AuthService,auth) 
{
  $scope.data = {};
...
.controller('ShopCtrl', function($window,$rootScope,$scope, $state, $http, $ionicPopup,$ionicLoading, AuthService,ProductService) 
{
  $ionicLoading.show
  ({
      template: 'Loading...'
